...
fun main() {
    ...
    var kutta = dog("kutta","deshi kutta", 1)  //object of dog class
    println("${kutta.name} is ${kutta.breed} is ${kutta.age} year old")
    kutta.age = 2
    println("${kutta.name} is ${kutta.breed} is ${kutta.age} year old")
...
//            else ->"computer"
//        }
//        if(winner=="tie") println("it was a TIE")
//        else if(winner=="player") println("you won")
